                ...
                if self.db.send_invite(member_doc['_id']):
                    ...
                    for board in boards:
                        if(board.name == self.current_group_name):
                            ...
                            calID = self.current_calendar_id
                            self.google_client.google_calendar.addAccessRule(calID, member_doc['user_id'])
            else:
...
########################################################################################################################
    ...
    def add_event(self):
        ...
        # might need to add date edit checker
            ...
            self.google_client.google_calendar.CreateEvent(self.current_calendar_id, event_name, event_description,
