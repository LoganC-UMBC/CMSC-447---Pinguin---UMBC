...
class GoogleCalendar(object):
    ...
    def getMonthEvents(self, calId = None, monthBegin = None, monthEnd = None):
        ...
        months_events = self.auth.service2.events().list(calendarId=calId, timeMin=dateStart, timeMax=dateEnd, singleEvents=True, timeZone='America/New_York', orderBy='startTime').execute()
